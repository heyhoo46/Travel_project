...
# 출력
print(f"현재 기온: {today_temp}C")
print(f"오늘 기온(C): {tw_temp}")
print(f"오늘, {today_ment}")
print(f"날씨 이미지: {image_url}")
...
for i in range(10):
    ...
    try:
        ...
        # 출력
        print(f"날짜: {date1}월{date2}일")
        print(f"최고 기온: {max_temp}C")
        print(f"최저 기온: {min_temp}C")
        print(f"날짜별 날씨 이미지: {weatherimg_url}")
